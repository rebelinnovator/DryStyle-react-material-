...
export const gqlLoadDryStyling = async () => {
    ...
    if (imagesAndMarketingSectionIds.marketingSectionIds.length > 0) {
        ...
        dryStylingSectionData.heroImage = data.marketingSection?.marketingComponentsCollection?.items[0]?.image.desktopMedia.url;
    }
    if (imagesAndMarketingSectionIds.marketingSectionIds.length > 1) {
        ...
        dryStylingSectionData.promo.image = data.marketingSection?.marketingComponentsCollection?.items[0]?.image.desktopMedia.url;
