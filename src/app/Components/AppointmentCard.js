...
const AppointmentCard = ({
    classes, appointment, isUpcoming, setSelectedAppointment,
}) => {
    const {
        StartDateTimeOffset, LocationName, AppointmentTreatments,
    } = appointment;
    // const isUpcoming = UserAppointmentPermissions.CanCheckin;
    const appointmentDate = extractDataMonthYearTime(StartDateTimeOffset);
    const detailsButtonText = isUpcoming ? 'Cancel' : 'View Details';
    // const viewSingleAppointDetails = !isUpcoming ? '/account/appointment-details' : '/account/my-appointments';
