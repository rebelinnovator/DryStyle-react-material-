...
const ServicesAddOnsCollection = ({
    ...
    const settings = {
        ...
        slidesToShow: 1,
        slidesToScroll: 1,
        appendDots: (dots) => <MagicSliderDots dots={dots} numDotsToShow={4} dotWidth={30} />,
        nextArrow: <NextArrow />,
        prevArrow: <PrevArrow />
    };
                                ...
                                <>
                                    <Grid className={classes.addOnsDescServices}>
                                        ...
                                        <Grid className={classes.serviceTime}>
                                            ...
                                            <Typography className={`${classes.addOnsTextBold} ${classes.marginServiceTime}`}>$15</Typography>
                                        </Grid>
                                    </Grid>
                                </>
                            ) : (
