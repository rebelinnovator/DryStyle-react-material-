...
const SlotsContainer = ({
    selectedDate, handleSelectSlot, classes, selectedSlot,
}) => {
    const { data, error, loading } = useFetch(getSlots(selectedDate));
                ...
                {slotData ? slotData.map((slot) => {
                    ...
                    return (
                        <Grid>
                            ...
                            {/* <span className={classes.slotsAvailable}>4 slots available</span> */}
                        </Grid>
                    );
                }) : null}
            </Grid>
