...
import { getIsEditEnabled, getSelectedSlot, getServicesDataFormatted } from '../../../state/ducks/Booking/Booking-Selectors';
...
const ReviewContainer = ({
    history, classes, slot, serviceData, clearState, isEditEnabled,
}) => {
