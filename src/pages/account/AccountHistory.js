...
const AccountHistory = ({ classes }) => (
    <Grid className={classes.containerShop}>
        ...
        <Grid className={classes.formContainer}>
            ...
            <Typography>Your Drybar orders are found a drybar.com. Proin gravida dolor sit amet lacus accumsan et viverra justo vigo. Proin sodales pulvinar sic tempor enorme nueos.</Typography>
        </Grid>
